...
<head>
    ...
    <title>Forgot Password & Reset Pin</title>
    <!-- Bootstrap CSS -->
			...
			<div class="row full-height justify-content-center">
				<div class="col-12 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						<h6 class="mb-0 pb-3"><span>Forgot Password </span><span>Reset Pin</span></h6>
						...
						<div class="card-3d-wrap mx-auto" >
							<div class="card-3d-wrapper">
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group mt-2">
												<input type="password" name="pw" class="form-style" placeholder="New Pin" id="logpass" >
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<div class="form-group mt-2">
												<input type="password" name="cw" class="form-style" placeholder="Confirm Pin" id="logpass" >
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<button type="submit" class="btn mt-4" name="forgotPass">Submit</button>
                            				</form>
				      					</div>
			      					</div>
			      				</div>
								<div class="card-back">
									<div class="center-wrap">
										<div class="section text-center">
											<h4 class="mb-4 pb-3">Reset Pin</h4>
											  <% if (request.getAttribute("status") != null) {%>
...
<form method="POST" id="reset" action="register">
    <div class="form-group mt-2">
        <input type="email" name="email" class="form-style" placeholder="Your Email" id="resetEmail" >
        <i class="input-icon uil uil-at"></i>
    </div>    
    <div class="form-group mt-2">
        <input type="password" name="opw" class="form-style" placeholder="Old Pin" id="oldPassword" >
        <i class="input-icon uil uil-lock-alt"></i>
    </div>
    <div class="form-group mt-2">
        <input type="password" name="npw" class="form-style" placeholder="New Pin" id="newPassword" >
        <i class="input-icon uil uil-lock-alt"></i>
    </div>
    <button type="submit" class="btn mt-4" name="reset">Submit</button>
</form>
